...
\begin{center}
\includegraphics[scale=1]{fig1_1.pdf} \includegraphics[scale=1]{fig1_2.pdf}
\end{center}
...
计算拓扑许和机器学习的研究人员发明了很多函数和数据的形状的方法。这里我简单回顾下我们再流形估计上的工
...
那么这个流形应该接近一个$d$维的超岭（hyper-ridge）
